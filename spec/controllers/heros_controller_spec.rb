...
describe HerosController do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hero as @hero" do
        ...
        post :create, {:hero => { "id" => "invalid value" }}, valid_session
        assigns(:hero).should be_a_new(Hero)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hero" do
        hero = Hero.create! valid_attributes
        # Assuming there are no other heros in the database, this
        # specifies that the Hero created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Hero.any_instance.should_receive(:update).with({ "id" => "1" })
        put :update, {:id => hero.to_param, :hero => { "id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hero as @hero" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hero.any_instance.stub(:save).and_return(false)
        put :update, {:id => hero.to_param, :hero => { "id" => "invalid value" }}, valid_session
        assigns(:hero).should eq(hero)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the heros list" do
      hero = Hero.create! valid_attributes
      delete :destroy, {:id => hero.to_param}, valid_session
      response.should redirect_to(heros_url)
    end
  end
