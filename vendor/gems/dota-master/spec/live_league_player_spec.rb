...
describe Steam::LiveLeague::Player do
  let(:player) { Steam::LiveLeague::Player.new(fixture(:live_league_player)) }
  ...
  it 'returns string representation of the object' do
    ...
    player.inspect.must_equal "#<Steam::LiveLeague::Player:0x#{object_id}>"
  end
end
